...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	cacheConfigHandler := handler.ProvideCacheConfigHandler(settingService, openAIGatewayService)
