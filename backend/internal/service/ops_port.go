...
type OpsRepository interface {
	...
	ListAIAnalysisTasks(ctx context.Context, limit int) ([]*OpsAIAnalysisTask, error)
	ListAIAnalysisReportHistory(ctx context.Context, limit int) ([]*OpsAIAnalysisReportHistoryItem, error)
	...
	GetIncidentImpact(ctx context.Context, filter *OpsDashboardFilter) (*OpsIncidentImpact, error)
	...
	GetCompoundAlertStats(ctx context.Context, filter *OpsCompoundAlertStatsFilter) (*OpsCompoundAlertStats, error)
