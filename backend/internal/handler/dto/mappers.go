...
func AccountFromServiceShallow(a *service.Account) *Account {
	...
	var upstreamCostMultiplier *string
	if a.UpstreamCostMultiplier != nil {
		value := a.UpstreamCostMultiplier.StringFixed(4)
		upstreamCostMultiplier = &value
	}
	out := &Account{
		ID:                              a.ID,
		Name:                            a.Name,
		...
		UpstreamCostMultiplierUpdatedAt: a.UpstreamCostMultiplierUpdatedAt,
		Status:                          a.Status,
