...
func (h *SettingHandler) GetSettings(c *gin.Context) {
	...
	payload := dto.SystemSettings{
		...
		AnnouncementTranslationEnabled:          settings.AnnouncementTranslationEnabled,
		AnnouncementTranslationBaseURL:          settings.AnnouncementTranslationBaseURL,
		AnnouncementTranslationAPIKeyConfigured: settings.AnnouncementTranslationAPIKeyConfigured,
		AnnouncementTranslationModel:            settings.AnnouncementTranslationModel,
		AnnouncementTranslationTimeoutSeconds:   settings.AnnouncementTranslationTimeoutSeconds,
		...
		BalanceLowNotifyExcludedUserIDs:         settings.BalanceLowNotifyExcludedUserIDs,
...
type UpdateSettingsRequest struct {
	...
	AnnouncementTranslationAPIKey         *string `json:"announcement_translation_api_key"`
	...
	BalanceLowNotifyExcludedUserIDs *[]int64                `json:"balance_low_notify_excluded_user_ids"`
...
func (h *SettingHandler) UpdateSettings(c *gin.Context) {
	...
	// 公告自动翻译配置：新字段使用指针区分“旧客户端未传”与“明确关闭/清空”。
	announcementTranslationEnabled := previousSettings.AnnouncementTranslationEnabled
	if req.AnnouncementTranslationEnabled != nil {
		announcementTranslationEnabled = *req.AnnouncementTranslationEnabled
	}
	announcementTranslationBaseURL := previousSettings.AnnouncementTranslationBaseURL
	if req.AnnouncementTranslationBaseURL != nil {
		announcementTranslationBaseURL = strings.TrimSpace(*req.AnnouncementTranslationBaseURL)
	}
	announcementTranslationModel := previousSettings.AnnouncementTranslationModel
	if req.AnnouncementTranslationModel != nil {
		announcementTranslationModel = strings.TrimSpace(*req.AnnouncementTranslationModel)
	}
	announcementTranslationTimeoutSeconds := previousSettings.AnnouncementTranslationTimeoutSeconds
	if req.AnnouncementTranslationTimeoutSeconds != nil {
		announcementTranslationTimeoutSeconds = *req.AnnouncementTranslationTimeoutSeconds
	}
	announcementTranslationAPIKey := ""
	if req.AnnouncementTranslationAPIKey != nil {
		announcementTranslationAPIKey = strings.TrimSpace(*req.AnnouncementTranslationAPIKey)
	}
	if announcementTranslationEnabled {
		if announcementTranslationBaseURL == "" {
			response.BadRequest(c, "Announcement translation base URL is required when enabled")
			return
		}
		if err := config.ValidateAbsoluteHTTPURL(announcementTranslationBaseURL); err != nil {
			response.BadRequest(c, "Announcement translation base URL is invalid: "+err.Error())
			return
		}
		if announcementTranslationModel == "" {
			response.BadRequest(c, "Announcement translation model is required when enabled")
			return
		}
		if announcementTranslationTimeoutSeconds <= 0 {
			response.BadRequest(c, "Announcement translation timeout must be positive when enabled")
			return
		}
		if announcementTranslationAPIKey == "" && previousSettings.AnnouncementTranslationAPIKey == "" {
			response.BadRequest(c, "Announcement translation API key is required when enabled")
			return
		}
	}
	...
	const (
		...
		maxMenuItemIDLen      = 32
		maxMenuItemContentLen = 1024 * 1024
	)
	...
	if req.CustomMenuItems != nil {
		...
		for i, item := range items {
			...
			if len(item.ContentMD) > maxMenuItemContentLen {
				response.BadRequest(c, "Custom menu item markdown content is too large (max 1MB)")
				return
			}
	...
	settings := &service.SystemSettings{
		...
		AnnouncementTranslationEnabled:        announcementTranslationEnabled,
		AnnouncementTranslationBaseURL:        announcementTranslationBaseURL,
		AnnouncementTranslationAPIKey:         announcementTranslationAPIKey,
		AnnouncementTranslationModel:          announcementTranslationModel,
		AnnouncementTranslationTimeoutSeconds: announcementTranslationTimeoutSeconds,
		...
		BalanceLowNotifyExcludedUserIDs: func() []int64 {
			if req.BalanceLowNotifyExcludedUserIDs != nil {
				return service.ParseBalanceLowNotifyExcludedUserIDs(service.MarshalBalanceLowNotifyExcludedUserIDs(*req.BalanceLowNotifyExcludedUserIDs))
			}
			return previousSettings.BalanceLowNotifyExcludedUserIDs
		}(),
	...
	payload := dto.SystemSettings{
		...
		AnnouncementTranslationEnabled:          updatedSettings.AnnouncementTranslationEnabled,
		AnnouncementTranslationBaseURL:          updatedSettings.AnnouncementTranslationBaseURL,
		AnnouncementTranslationAPIKeyConfigured: updatedSettings.AnnouncementTranslationAPIKeyConfigured,
		AnnouncementTranslationModel:            updatedSettings.AnnouncementTranslationModel,
		AnnouncementTranslationTimeoutSeconds:   updatedSettings.AnnouncementTranslationTimeoutSeconds,
...
func diffSettings(before *service.SystemSettings, after *service.SystemSettings, beforeAuthSourceDefaults *service.AuthSourceDefaultSettings, afterAuthSourceDefaults *service.AuthSourceDefaultSettings, req UpdateSettingsRequest) []string {
	...
	if before.AnnouncementTranslationEnabled != after.AnnouncementTranslationEnabled {
		changed = append(changed, "announcement_translation_enabled")
	}
	if before.AnnouncementTranslationBaseURL != after.AnnouncementTranslationBaseURL {
		changed = append(changed, "announcement_translation_base_url")
	}
	if req.AnnouncementTranslationAPIKey != nil && strings.TrimSpace(*req.AnnouncementTranslationAPIKey) != "" {
		changed = append(changed, "announcement_translation_api_key")
	}
	if before.AnnouncementTranslationModel != after.AnnouncementTranslationModel {
		changed = append(changed, "announcement_translation_model")
	}
	if before.AnnouncementTranslationTimeoutSeconds != after.AnnouncementTranslationTimeoutSeconds {
		changed = append(changed, "announcement_translation_timeout_seconds")
	}
	...
	if !slices.Equal(before.BalanceLowNotifyExcludedUserIDs, after.BalanceLowNotifyExcludedUserIDs) {
		changed = append(changed, "balance_low_notify_excluded_user_ids")
	}
