...
func registerOpsRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	ops := admin.Group("/ops")
	{
		...
		// Incident overview
		ops.GET("/incidents/overview", h.Admin.Ops.GetIncidentOverview)
...
func registerDashboardRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	dashboard := admin.Group("/dashboard")
	{
		...
		dashboard.GET("/revenue-overview", h.Admin.Dashboard.GetRevenueOverview)
		dashboard.GET("/repurchase-distribution", h.Admin.Dashboard.GetRepurchaseDistribution)
...
func registerAccountRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	accounts := admin.Group("/accounts")
	{
		...
		accounts.POST("/:id/upstream-models", h.Admin.Account.FetchUpstreamModels)
