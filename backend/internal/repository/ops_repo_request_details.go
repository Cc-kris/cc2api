...
WITH combined AS (
  SELECT
    ...
    COALESCE(NULLIF(ul.upstream_model, ''), NULLIF(ul.requested_model, ''), NULLIF(ul.model, ''), '') AS upstream_model,
  ...
  SELECT
    ...
    COALESCE(NULLIF(o.upstream_model, ''), NULLIF(o.requested_model, ''), NULLIF(o.model, ''), '') AS upstream_model,
