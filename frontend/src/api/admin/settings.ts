...
// ── 平台限额类型 ──────────────────────────────────────────────────
export type PlatformType = "anthropic" | "openai" | "gemini" | "antigravity" | "seedace"
...
const PLATFORMS: PlatformType[] = ["anthropic", "openai", "gemini", "antigravity", "seedace"]
...
export interface SystemSettings {
  ...
  local_response_cache_enabled: boolean;
