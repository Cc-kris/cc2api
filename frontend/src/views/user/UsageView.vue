          ...
          <div class="flex items-center gap-3">
            ...
            <div>
              ...
              <p class="text-xl font-bold text-gray-900 dark:text-white">
                {{ formatNumberLocaleString(usageStats?.total_requests || 0) }}
              </p>
                ...
                <div class="flex items-center gap-2">
                  ...
                  <div class="inline-flex items-center gap-1">
                    ...
                    <span class="font-medium text-gray-900 dark:text-white">{{
                      formatNumberLocaleString(row.input_tokens)
                    }}</span>
                  </div>
                  <!-- Output -->
                  <div class="inline-flex items-center gap-1">
                    ...
                    <span class="font-medium text-gray-900 dark:text-white">{{
                      formatNumberLocaleString(row.output_tokens)
                    }}</span>
                  </div>
                </div>
        ...
        <div class="space-y-1.5">
          ...
          <div>
            ...
            <div v-if="tokenTooltipData && tokenTooltipData.input_tokens > 0" class="flex items-center justify-between gap-4">
              ...
              <span class="font-medium text-white">{{ formatNumberLocaleString(tokenTooltipData.input_tokens) }}</span>
            </div>
            <div v-if="tokenTooltipData && tokenTooltipData.output_tokens > 0" class="flex items-center justify-between gap-4">
              <span class="text-gray-400">{{ t('admin.usage.outputTokens') }}</span>
              <span class="font-medium text-white">{{ formatNumberLocaleString(tokenTooltipData.output_tokens) }}</span>
            </div>
            <div v-if="tokenTooltipData && tokenTooltipData.cache_creation_tokens > 0">
              ...
              <template v-if="tokenTooltipData.cache_creation_5m_tokens > 0 || tokenTooltipData.cache_creation_1h_tokens > 0">
                <div v-if="tokenTooltipData.cache_creation_5m_tokens > 0" class="flex items-center justify-between gap-4">
                  ...
                  <span class="font-medium text-white">{{ formatNumberLocaleString(tokenTooltipData.cache_creation_5m_tokens) }}</span>
                </div>
                <div v-if="tokenTooltipData.cache_creation_1h_tokens > 0" class="flex items-center justify-between gap-4">
                  ...
                  <span class="font-medium text-white">{{ formatNumberLocaleString(tokenTooltipData.cache_creation_1h_tokens) }}</span>
                </div>
              </template>
              <!-- 无明细时，只显示聚合值 -->
              <div v-else class="flex items-center justify-between gap-4">
                <span class="text-gray-400">{{ t('admin.usage.cacheCreationTokens') }}</span>
                <span class="font-medium text-white">{{ formatNumberLocaleString(tokenTooltipData.cache_creation_tokens) }}</span>
              </div>
            </div>
            ...
            <div v-if="tokenTooltipData && tokenTooltipData.cache_read_tokens > 0" class="flex items-center justify-between gap-4">
              ...
              <span class="font-medium text-white">{{ formatNumberLocaleString(tokenTooltipData.cache_read_tokens) }}</span>
            </div>
          </div>
          <!-- Total -->
          <div class="flex items-center justify-between gap-6 border-t border-gray-700 pt-1.5">
            <span class="text-gray-400">{{ t('usage.totalTokens') }}</span>
            <span class="font-semibold text-blue-400">{{ formatNumberLocaleString((tokenTooltipData?.input_tokens || 0) + (tokenTooltipData?.output_tokens || 0) + (tokenTooltipData?.cache_creation_tokens || 0) + (tokenTooltipData?.cache_read_tokens || 0)) }}</span>
          </div>
        </div>
