...
describe("admin SettingsView payment visible method controls", () => {
  ...
  it("does not render cache management content inside general settings", async () => {
    const wrapper = mountView();
...
describe("admin SettingsView platform quota matrix", () => {
  ...
  it("保存时 updateSettings payload 应包含嵌套 default_platform_quotas 对象（含全平台）", async () => {
    ...
    const platforms = ["anthropic", "openai", "gemini", "antigravity", "seedace"];
