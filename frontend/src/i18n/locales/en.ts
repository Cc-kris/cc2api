export default {
  ...
  auth: {
    agreement: {
      ...
      mustAgreeTitle: 'Accept the latest terms before continuing.',
      mustAgreeDescription: 'You can enter your account details first, but sign-in requires acceptance and quick sign-in remains disabled.',
      viewTerms: 'View terms',
      updateTitle: 'Terms update notice',
      updatedDescription: 'Our terms were updated {date}. Review and accept them before continuing.',
      recent: 'recently',
      relatedDocuments: 'Related documents',
      reject: 'Reject',
      acceptAndContinue: 'Accept and continue',
      loginRejectWarning: 'Accept the latest terms before signing in.',
      loginRequiredWarning: 'Review and accept the latest terms before signing in.',
      registerRejectWarning: 'Accept the latest terms before registering or using quick sign-in.',
      registerRequiredWarning: 'Review and accept the latest terms before registering.'
    },
    defaultSiteSubtitle: 'Subscription to API Conversion Platform',
    ...
    oauthFlow: {
      ...
      wechatNativeAppRequired: 'This site only has WeChat mobile app sign-in configured. Continue from the native app through the WeChat SDK.',
  ...
  videoGeneration: {
    ...
    selectApiKey: 'Select a Seedance API key',
    noApiKeys: 'No API key is currently available for the Seedace group.',
    modelLabel: 'Model',
    ...
    referenceImagesHint: 'Optional, fewer than 9 images',
    uploadReferenceImages: 'Upload reference images',
    frameReference: 'First/last frame reference',
    uploadFirstFrame: 'Upload first frame',
    uploadLastFrame: 'Upload last frame',
    referenceVideos: 'Reference videos',
    referenceVideosHint: 'Optional, fewer than 3 videos and each under 15 seconds',
    uploadReferenceVideos: 'Upload reference videos',
    referenceAudios: 'Reference audio',
    referenceAudiosHint: 'Optional, up to 3 MP3/WAV/M4A files',
    uploadReferenceAudios: 'Upload reference audio',
    audioNeedsImage: 'At least one reference image is required when reference audio is uploaded.',
    dialogTitle: 'Video generation conversation',
    dialogDescription: 'The result is polled automatically after submission. A download button appears when generation completes.',
    newConversation: 'New conversation',
    history: 'History',
    emptyHistory: 'No generation history',
    generationCount: '{count} generations',
    lastGenerated: 'Last generated {time}',
    emptyConversation: 'Select an API key and model, then enter a prompt below.',
    polling: 'Polling generation result',
    download: 'Download',
    expiryWarning: 'This video is available for 24 hours. Download it in time.',
    promptPlaceholder: 'Enter the video prompt to submit',
    submit: 'Submit',
    generating: 'Generating',
    generated: 'Video generated',
    generationFailed: 'Generation failed',
    unnamedSession: 'Untitled conversation',
    remove: 'Remove',
    models: {
    ...
    frameModes: {
      ...
      startEnd: 'First and last frames'
    },
    audioOptions: {
      yes: 'Yes, with audio',
      no: 'No, muted video'
    ...
    errors: {
      historyLoadFailed: 'Failed to load video generation history',
      historySaveFailed: 'Failed to save video generation history',
      apiKeysLoadFailed: 'Failed to load API keys',
      apiKeyRequired: 'Select an API key',
      modelRequired: 'Select a model',
      resolutionRequired: 'Select a resolution',
      unsupportedResolution: 'The selected model does not support this resolution',
      aspectRatioRequired: 'Select an aspect ratio',
      durationRequired: 'Select a duration',
      promptRequired: 'Enter a video generation prompt',
      tooManyImages: 'No more than 9 reference images are allowed',
      tooManyVideos: 'No more than 3 reference videos are allowed',
      tooManyAudios: 'No more than 3 reference audio files are allowed',
      videoTooLong: 'Each reference video must be shorter than 15 seconds',
      audioImageRequired: 'At least one reference image is required with reference audio',
      firstFrameRequired: 'Upload a first-frame image for this mode',
      lastFrameRequired: 'Upload a last-frame image for this mode',
      upstreamTaskMissing: 'The upstream service did not return a task ID',
      upstreamFailed: 'The upstream service reported generation failure',
      pollingTimeout: 'Polling timed out before a video link was returned. Try again later.',
      downloadFailed: 'Failed to download the video',
      imageTypeInvalid: 'Reference images must use an image format',
      audioTypeInvalid: 'Reference audio supports formats such as MP3, WAV, and M4A',
      fileReadFailed: 'Failed to read the file',
      videoReadFailed: 'Failed to read the reference video'
    }
  },
  usage: {
    title: 'Usage Records',
    description: 'View and analyze your API usage history',
    tabs: { label: 'Usage views', details: 'Details', errors: 'Error requests', ranking: 'User Token ranking', errorsHint: 'Open the unified error view to inspect failed requests and SLA classification.', openErrors: 'Open error requests' },
    tokenRanking: { title: 'User Token ranking', range: '{start} to {end}', user: 'User', failed: 'Failed to load ranking', empty: 'No token usage in this range' },
  ...
  monitorCommon: {
    ...
    quotaState: {
      ...
      billing_observed: 'Billing observed'
    },
  ...
  modelSquare: {
    title: 'Model Square',
    description: 'Browse available models, billing modes, original prices, and multiplier prices by group.',
    publicGroups: 'Public Groups',
    selectGroup: 'Select Group',
    searchGroups: 'Search groups',
    searchModels: 'Search models in this group',
    clearSearch: 'Clear search',
    updatedAt: 'Catalog updated {value}',
    modelCount: '{count} models',
    custom: 'Custom',
    defaultMultiplier: 'Default multiplier {value}×',
    myMultiplier: 'My multiplier {value}×',
    multiplierPrice: 'Multiplier price',
    originalPrice: 'Original price',
    free: 'Free',
    modelTable: 'Model price list',
    copyModel: 'Copy model name',
    modelCopied: 'Model name copied',
    viewFast: 'View Fast prices',
    viewTiers: 'View {count} tiers',
    tokens: 'tokens',
    allLoaded: 'All models loaded',
    catalogChanged: 'The model catalog changed and is being reloaded.',
    loadFailed: 'Failed to load Model Square',
    noGroups: 'No public groups',
    noGroupsDescription: 'There are no public or exclusive groups available to you.',
    noModels: 'No models are currently available in this group',
    noModelsDescription: 'Switch to another group to browse its models.',
    noSearchResults: 'No matching models in this group',
    noSearchResultsDescription: 'Clear the search to view all models.',
    columns: {
      name: 'Model',
      billingMode: 'Billing',
      input: 'Input',
    ...
    pricingSources: {
      ...
      mixed: 'System price with channel overrides'
    },
    units: {
      per_1m_tokens: '1M tokens',
      per_1m_cache_tokens: '1M cache tokens',
      per_request: 'request',
      per_image: 'image',
      per_second: 'second'
    }
  ...
  admin: {
    ...
    users: {
      ...
      balanceFilter: {
        ...
        lte: 'Less or equal',
        between: 'Between',
        amountPlaceholder: 'Balance',
        minPlaceholder: 'Min balance',
        maxPlaceholder: 'Max balance',
        minRequired: 'Enter minimum balance',
        maxRequired: 'Enter maximum balance',
        invalidAmount: 'Enter an amount with up to 4 decimals; negative values are allowed',
        maxMustBeGteMin: 'Maximum balance must be greater than or equal to minimum balance'
      },
      searchGroups: 'Search groups...',
      ...
      bulk: {
        ...
        delete: 'Bulk Delete',
        addTags: 'Bulk Tag',
        addTagsTitle: 'Bulk Tag Users',
        addTagsHint: 'Add tags to the selected {count} user(s). Existing tags will not be removed.',
        noTags: 'No tags yet. Create tags in Tag Management first.',
        tagRequired: 'Select at least one tag',
        disableConfirm: 'Disable the selected {count} user(s)? Admin accounts will fail and remain enabled.',
        deleteConfirm: 'Delete the selected {count} user(s)? This cannot be undone. Admin accounts will fail.',
        partialSuccess: '{success} succeeded, {failed} failed',
        deleteSuccess: 'Deleted {count} user(s)',
        disableSuccess: 'Disabled {count} user(s)',
        tagSuccess: 'Added tags to {count} user(s)'
      },
    ...
    groups: {
      ...
      videoPricing: {
        title: 'Grok Video Generation Pricing',
        description: 'Configure per-second base prices by resolution. Empty values use the official xAI defaults.',
        independentMultiplier: 'Use independent video multiplier',
        videoMultiplier: 'Video multiplier',
        modeHint: 'Video cost = per-second price × duration × output count × effective multiplier. Shared mode uses the current effective group multiplier.'
      },
      claudeCode: {
    ...
    channels: {
      ...
      form: {
        ...
        codexImageGenerationBridgeHint: 'When enabled, eligible Codex /responses requests automatically receive the image_generation tool so image-capable groups can route them consistently.',
    ...
    channelMonitor: {
      ...
      importAccountsButton: 'Import Upstream Monitors',
      ...
      importAccountsSuccess: 'Created {created} upstream monitor(s), skipped {duplicate} duplicate upstream(s) and {unsupported} unsupported account(s), from {total} account(s).',
      importAccountsFailed: 'Failed to import upstream monitors',
      ...
      form: {
        ...
        modeActive: 'Active probe',
        modeActiveHint: 'Run scheduled upstream checks and record latency/status.',
        modePassive: 'Passive telemetry',
        modePassiveHint: 'Do not send probes; classify status from observed traffic.',
        modeQuota: 'Quota snapshot',
        modeQuotaHint: 'Do not send probes; use account quota snapshots when available.',
        accountId: 'Bound account ID',
        accountIdPlaceholder: 'Optional upstream account ID',
        accountIdHint: 'Used by passive telemetry and quota snapshots when those collectors are enabled.',
        accountSearchPlaceholder: 'Search account by name (300ms debounce)',
    ...
    accounts: {
      ...
      toolActions: 'Tools',
      batchTest: {
        action: 'Test All Enabled',
        testing: 'Testing...',
        statusTesting: 'Testing',
        statusPass: 'Passed',
        statusError: 'Error',
        statusErrorWithCode: 'Error {code}',
        done: 'Test completed: {total} total, {passed} passed, {failed} failed',
        failed: 'Batch test failed'
      },
      viewColumns: 'Columns',
      selectedCount: '{count} selected',
      ...
      teamWorkspace: {
        title: 'OpenAI Team workspace is temporarily excluded from scheduling',
        refresh: 'Refresh status',
        refreshing: 'Refreshing',
        affected: 'Workspace: {teamId}; affected accounts: {accountIds}.',
        none: 'none',
        probeAt: 'Automatic recovery probe: {time}.',
        recoveryHint: 'Use “Test Account” in the account list to start one controlled recovery probe.',
        loadFailed: 'Unable to load the Team workspace status.',
        retry: 'Retry'
      },
      tempUnschedulable: {
      ...
      bulkEdit: {
        ...
        resultSummary: 'Bulk result: {success} updated, {unchanged} unchanged, {failed} failed',
        copyFailed: 'Copy failed accounts',
        failedCopied: 'Failed account IDs copied',
        upstreamSeparateOnly: 'The upstream multiplier must be updated separately from all other fields',
        upstreamConfirmTitle: 'Confirm Upstream Multiplier Update',
        upstreamConfirmMessage: 'This affects {count} accounts. Current distribution: {distribution}; new multiplier: {value}. Only requests selecting these accounts afterward are affected.',
        distributionUnavailable: 'The backend will compare each account in the filtered scope',
      ...
      openai: {
        ...
        codexIdentityMode: 'Codex identity policy',
        codexIdentityModeDesc:
          'Only applies to OpenAI OAuth. Controls identity fields shared by HTTP, WebSocket, and connection tests; no token is generated or stored.',
        codexIdentityModeDisabled: 'Disabled (legacy behavior)',
        codexIdentityModeDevice: 'Device',
        codexIdentityModeSession: 'Device + session',
        codexIdentityModeFull: 'Full (device + session + User-Agent)',
      ...
      fetchingUpstreamModels: 'Fetching upstream models...',
      fetchUpstreamModelsSuccess: 'Filled {count} upstream model(s)',
      fetchUpstreamModelsEmpty: 'No models returned by upstream',
      fetchUpstreamModelsDisabledByPassthrough: 'Automatic passthrough is enabled: model mapping is disabled and cannot be filled.',
      ...
      billingRateMultiplierHint: 'Used for account quotas, statistics, and alerts; does not affect customer pricing or procurement cost',
      upstreamCostMultiplier: 'Upstream Multiplier',
      upstreamCostMultiplierHint: 'Used for procurement cost and profit calculation; does not affect customer charges',
      upstreamCostMultiplierUnconfigured: 'Not configured',
      upstreamCostMultiplierInvalid: 'Upstream multiplier must be 0 to 9999.9999 with at most 4 decimal places',
      upstreamCostMultiplierChangeReason: 'Change reason',
      upstreamCostMultiplierChangeReasonHint: 'Enter 5 to 500 characters describing the basis for this change',
      upstreamCostMultiplierChangeNotice: 'Previous: {oldValue}; new: {newValue}. Saving affects only requests that select this account afterward.',
      upstreamCostMultiplierUpdated: 'Upstream multiplier updated. Only newly selected requests are affected.',
      upstreamMultiplierHistory: 'Upstream Multiplier History',
      upstreamMultiplierHistoryEmpty: 'No multiplier changes',
      upstreamMultiplierHistoryLoadFailed: 'Failed to load multiplier history',
      upstreamMultiplierEffectiveAt: 'Effective at',
      upstreamMultiplierOldValue: 'Previous',
      upstreamMultiplierNewValue: 'New',
      upstreamMultiplierOperator: 'Operator',
      upstreamMultiplierReason: 'Reason',
      upstreamMultiplierViewAll: 'View all',
      upstreamMultiplierPreviousPage: 'Previous',
      upstreamMultiplierNextPage: 'Next',
      expiresAt: 'Expires At',
    ...
    ops: {
      ...
      platformSla: 'Platform SLA',
      userSuccessRate: 'User Success Rate',
      totalFailures: 'Failed Requests',
      clientErrors: 'Client Errors',
      platformErrors: 'Platform Errors',
      platformSlaErrors: 'Platform SLA Errors',
      upstreamLimited: 'Upstream Limits / Resource Risk',
      businessLimitedDetails: 'Business Limited',
      ...
      errorReasons: {
        ...
        quotaExceeded: 'Quota or usage limit exceeded',
        upstreamRateLimited: 'Upstream rate limited',
        upstreamOverloaded: 'Upstream overloaded',
        upstreamTimeout: 'Upstream timeout',
        upstreamError: 'Upstream error',
        routingFailed: 'Routing failed or no available account',
        platformError: 'Platform internal error',
        clientAuthError: 'Client authentication error',
      ...
      errorDetail: {
        ...
        platformSlaImpact: 'Impacts Platform SLA',
      ...
      incidentOverview: {
        title: 'Ops Incident Overview',
        description: 'Current incident state, impact scope, and AI analysis entry for the selected window.',
        autoRefresh: 'Auto refresh in {seconds}s',
        manualAnalysis: 'Run AI Analysis',
        lastUpdated: 'Last refreshed',
        currentWindow: 'Current window',
        loadFailed: 'Failed to load incident overview',
        statusCard: 'Current status',
        riskScore: 'Health risk score',
        viewScoreReasons: 'View score reasons',
        scoreReasonsTitle: 'Score Reasons',
        scoreReasonEmpty: 'No abnormal reasons',
        primarySummary: 'Primary summary',
        viewDetails: 'View Details',
        noDetails: 'No details available',
        noSummary: 'No issue requires action right now.',
        noRecommendedActions: 'No extra actions recommended.',
        impactTitle: 'Impact Scope',
        impactDescription: 'Quickly identify current blast radius and handling priority.',
        finalFailures: 'Final failures',
        recoveredFluctuations: 'Recovered fluctuations',
        affectedUsers: 'Affected users',
        affectedApiKeys: 'Affected API keys',
        affectedModels: 'Affected models',
        affectedAccounts: 'Affected upstream accounts',
        recoveredHint: 'Click to inspect related errors',
        userImpactHint: 'Click to inspect related errors',
        apiKeyImpactHint: 'Click to inspect related errors',
        none: 'None',
        unknownModel: 'Unknown model',
        unknownAccount: 'Unknown upstream account',
        latestAnalysisTitle: 'Latest AI Analysis',
        latestAnalysisDescription: 'Open the latest analysis, or run a new AI analysis for the current filter window.',
        openAnalysis: 'Open Analysis',
        noAnalysis: 'No AI analysis yet',
        analysisExpired: 'Analysis expired',
        analysisDialogTitle: 'AI Analysis Details',
        analysisLoading: 'Loading AI analysis details...',
        ...
        noQuickFilters: 'No quick filters are available right now.',
        emptyTitle: 'No incident overview data',
        emptyDescription: 'There is no aggregated incident data for the current filter window.',
        ...
        analysisDisabled: {
          ...
          timeTooLarge: 'Manual AI analysis supports up to a 24-hour window.'
        },
        timeRanges: {
          '1m': 'Last 1 minute',
          '5m': 'Last 5 minutes',
      ...
      unifiedErrorDetail: {
        ...
        viewLogs: 'View Logs',
        manualAnalysis: 'Run AI Analysis',
        invalidId: 'Invalid error detail id.',
        emptySummary: 'No summary available',
        unknown: 'Unknown',
        unknownUser: 'Unknown user',
        unknownApiKey: 'Unknown API key',
        ungrouped: 'Ungrouped',
        hiddenUpstreamAccount: 'Hidden',
        unclassified: 'Unclassified',
        unconfirmed: 'Unconfirmed',
        notAnalyzed: 'Not analyzed',
        noReason: 'No classification reason available',
        ...
        sections: {
          ...
          sameKindErrors: 'Same-kind Issues'
        },
        fields: {
          requestId: 'Request ID',
          ...
          clientStatusCode: 'Client Status Code',
          errorOwner: 'Owner',
          errorSource: 'Source',
        ...
        aiDisabled: {
          ...
          running: 'An AI analysis task is already running for this error.'
        }
      },
      alertEvents: {
        title: 'Alert Events',
        ...
        detail: {
          ...
          statusActionsTitle: 'Status Actions',
          statusActionsHint: 'Acknowledge, mark processing, close, or silence the event. The latest state refreshes immediately after submit.',
          actionNoteLabel: 'Note',
          actionNotePlaceholder: 'Optional note for acknowledgment, processing, or close reason',
          processingActionLabel: 'Processing Action',
          processingActionPlaceholder: 'Optional next action when marking processing',
          acknowledge: 'Acknowledge',
          acknowledgeSuccess: 'Alert acknowledged',
          acknowledgeFailed: 'Failed to acknowledge alert',
          markProcessing: 'Mark Processing',
          processingSuccess: 'Alert marked as processing',
          processingFailed: 'Failed to mark alert as processing',
          close: 'Close Alert',
          closeSuccess: 'Alert closed',
          closeFailed: 'Failed to close alert',
      ...
      alertRules: {
        title: 'Alert Rules',
        description: 'View alert rules, filter by level, status, and keyword, and maintain compound alert rules.',
        loading: 'Loading...',
        ...
        deleteConfirmMessage: 'This will remove the rule and its related alert events. Continue?',
        ...
        recoveredPolicies: {
          ...
          alert: 'Participate in alerts'
        },
        hints: {
          groupOptional: 'Optional: limit the rule to a specific group via group_id.',
          emailRecipientsReady: 'Email notifications reuse the global recipients from Ops settings.',
          emailRecipientsMissing: 'No global email recipients are configured. Saving with email notifications enabled will be blocked.',
          readonlyLegacy: 'This migrated legacy rule is read-only and cannot be edited in this dialog.'
        },
        filters: {
        ...
        form: {
          ...
          minFailureRate: 'Min failure rate (%)',
          minSampleCount: 'Min sample count',
          impactScope: 'Impact scope conditions',
          recoveredPolicy: 'Recovered fluctuation handling',
          minRecoveredFluctuations: 'Min recovered fluctuations',
          autoAIAnalysis: 'Auto AI analysis',
          notificationChannels: 'Notification channels',
          silenceMinutes: 'Silence time (minutes)',
        ...
        validation: {
          ...
          nameLength: 'Rule name must be 2 to 50 characters',
          ...
          minSampleCountRequiredForRate: 'Percentage-based rules require both min final failures and min sample count',
          minFinalFailuresGtSample: 'Min final failures cannot be greater than min sample count',
          impactScopeRange: 'Impact scope values must be integers between 1 and 100000',
          minRecoveredRequired: 'Recovered fluctuation alerts require a minimum recovered count',
          notificationNoneExclusive: 'Notification channel "None" cannot be combined with other channels',
          emailRecipientsRequired: 'Please configure email recipients first',
          silenceMinutesRange: 'Please enter an integer number of minutes between 0 and 1440',
          descriptionLength: 'Maximum length is 500 characters'
        },
      ...
      email: {
        ...
        healthScoreThreshold: 'Health score threshold',
        healthScoreIntervalMinutes: 'Reminder interval (minutes)',
        ...
        validation: {
          ...
          healthScoreThresholdRange: 'Health score threshold must be between 1 and 100',
          healthScoreIntervalRange: 'Reminder interval must be between 1 and 1440 minutes',
    ...
    settings: {
        ...
        aiAnalysisConfigHint: 'Configure the endpoint, model, automatic analysis levels, and manual analysis switch used by Ops AI analysis.',
        aiAnalysisConfigEnabled: 'Enabled',
        aiAnalysisConfigDisabled: 'Disabled',
        aiAnalysisConfigNotLoaded: 'Not loaded',
        aiAnalysisNoAutoLevels: 'No automatic analysis',
        aiAnalysisStatus: 'Status',
        aiAnalysisModel: 'Interface / Model',
        aiAnalysisEndpoint: 'Endpoint',
        aiAnalysisAutoLevels: 'Auto levels',
        aiAnalysisTest: 'Test connection',
        aiAnalysisTesting: 'Testing...',
        aiAnalysisTestSuccess: 'AI analysis connection test succeeded',
        aiAnalysisTestFailed: 'AI analysis connection test failed',
        aiAnalysisOpenConfig: 'Open AI config',
      ...
      tooltips: {
        ...
        userSuccessRate: 'Final user request success rate, including client errors, business limits, and upstream limits as user-visible failures.',
    ...
    cacheManagement: {
      ...
      refresh: 'Refresh config',
      openStats: 'Open Cache Stats',
      openAdvanced: 'Advanced Cache Policy',
      retry: 'Retry',
      save: 'Save config',
      saving: 'Saving...',
      saved: 'Cache configuration saved',
      loadFailed: 'Failed to load cache configuration',
      saveFailed: 'Failed to save cache configuration',
      export: 'Export cache stats',
      exporting: 'Exporting...',
      exportSuccess: 'Cache stats exported successfully',
      exportFailed: 'Failed to export cache stats',
      exportNoPermission: 'Your current role is not allowed to export cache stats.',
      exportHint: 'Only platform owners and operations roles can export cache stats CSV. Backend failure reasons are shown when export fails.',
      exportHintReadonly: 'Your current role can view cache stats entry points but cannot export CSV.',
      resetChanges: 'Discard unsaved changes',
      resetDefaultValues: 'Restore safe defaults',
      readonlyNotice: 'Your current role can view this cache configuration but cannot save changes.',
      validationTitle: 'Fix the following issues before saving:',
      ...
      sectionCards: {
        ...
        pending: 'Later task',
        configTitle: 'Cache config',
        configDescription: 'Delivered in this task: switches, TTL, size, model lists, and save validation.',
        statsTitle: 'Cache stats',
        statsDescription: 'Summary cards, model table, bypass reasons, and store-skip reasons are now available.',
        maintenanceTitle: 'Cache maintenance',
        maintenanceDescription: 'Scoped clear actions and audit history will be added in later tasks.',
      ...
      summary: {
        global: 'Global cache',
        ttl: 'Default TTL',
        requestLimit: 'Request size limit',
        responseLimit: 'Response size limit',
      },
      sections: {
        switches: 'Switches',
        limits: 'Limits and thresholds',
        models: 'Model lists',
        scope: 'Fixed rules',
        defaults: 'Safe defaults',
      },
      switchesHint: 'When the global switch is off, no platform reads from or writes to the local response cache.',
      limitsHint: 'TTL, byte limits, and the temperature threshold are validated with the same bounds as the backend.',
      modelsHint: 'You can input one model per line or separate them with commas; blank lines are ignored and duplicates are removed automatically.',
      scopeTitle: 'Cache scope',
      scopeValue: 'API Key + Group + Platform + Model + Endpoint + Body',
      scopeHint: 'The cache scope is fixed by the system for this release. Cross-user sharing is not allowed and cannot be edited here.',
      bypassHeaderTitle: 'Client bypass header',
      defaults: {
        ttl: 'Default TTL',
        temperature: 'Default temperature threshold',
        requestLimit: 'Default request size limit',
        responseLimit: 'Default response size limit',
      },
      fields: {
        globalEnabled: {
          label: 'Global cache switch',
          hint: 'When disabled, all platforms stop both reading and writing the local response cache.',
        },
        platformHint: 'Controls whether this platform can use cache independently.',
        ttl: {
          label: 'TTL (seconds)',
          hint: 'Valid range: 60 to 86400 seconds. Only new cache writes are affected after a change.',
        },
        temperature: {
          label: 'Temperature threshold',
          hint: 'Valid range: 0 to 2. Requests above the threshold bypass cache.',
        },
        maxRequestBytes: {
          label: 'Request size limit (bytes)',
          hint: 'Currently about {value}. Valid range: 1024 to 5242880 bytes.',
        },
        maxResponseBytes: {
          label: 'Response size limit (bytes)',
          hint: 'Currently about {value}. Valid range: 1024 to 10485760 bytes.',
        },
        allowlist: {
          label: 'Model allowlist',
          placeholder: 'For example:\ngpt-4.1\nclaude-3-7-sonnet-*',
          hint: 'Leave empty to allow all models. Exact and wildcard matches are supported.',
        },
        blocklist: {
          label: 'Model blocklist',
          placeholder: 'For example:\ngpt-4o-audio-*\ngemini-1.5-pro-exp',
          hint: 'Blocked models always bypass cache and cannot overlap with the allowlist.',
        },
      },
      validation: {
        ttl: 'TTL must be between 60 and 86400 seconds.',
        maxRequestBytes: 'Request size limit must be between 1024 and 5242880 bytes.',
        maxResponseBytes: 'Response size limit must be between 1024 and 10485760 bytes.',
        maxTemperature: 'Temperature threshold must be between 0 and 2.',
        modelOverlap: 'Allowlist and blocklist cannot both include: {model}',
      },
      nav: {
        home: 'Home',
        config: 'Config',
      ...
      advancedPage: {
        title: 'Advanced Cache Policy',
        description: 'Manage advanced cache switches, gray scope, and capacity/compression/hotspot/savings metrics in one place.',
        loadFailed: 'Failed to load advanced cache configuration',
        saveFailed: 'Failed to save advanced cache configuration',
        saved: 'Advanced cache configuration saved',
        statsLoadFailed: 'Failed to load advanced cache stats',
        readonlyNotice: 'Your current role can only view advanced cache stats and cannot save configuration changes.',
        noPermission: 'Your current role is not allowed to perform this action.',
        hiddenAmount: 'Amount hidden',
        priceMissing: 'Pricing missing',
        actions: {
          backToCache: 'Back to cache management',
          refresh: 'Refresh page',
          save: 'Save config',
          saving: 'Saving...',
        },
        alerts: {
          disabled: 'Advanced policy is disabled. Live traffic is currently using exact cache only.',
          fallback: 'The system has fallen back to exact cache. Reason: {reason}',
        },
        fallbackReasons: {
          disabled: 'Advanced cache is disabled',
        },
        form: {
          title: 'Advanced configuration',
          hint: 'When the main switch is off, the page only saves configuration. If the gray scope is empty, no production traffic can use advanced cache.',
        },
        filters: {
          title: 'Stats filters',
          hint: 'Capacity, compression, hotspots, and savings all follow the same filters.',
          timeRange: 'Time range',
          hotspotLimit: 'Hotspot limit',
          platform: 'Platform',
          group: 'Group',
          model: 'Model',
        ...
        info: {
          ...
          grayScope: 'Gray scope',
          grayScopeValue: '{apiKeys} API keys, {groups} groups, {models} models',
          responseLimit: 'Response cache size limit',
          updatedAt: 'Stats updated at',
        },
        summary: {
          mode: 'Advanced cache switch',
          grayScopeEmpty: 'If gray scope is empty, advanced cache does not affect production traffic.',
          capacity: 'Redis capacity limit',
          safeLimit: 'Memory safe limit {value} MB',
          compression: 'Single-entry compression',
          compressionThreshold: 'Compression threshold {value} KB',
          updatedAt: 'Stats updated at',
        },
        sections: {
          capacity: 'Capacity control',
          compression: 'Compression gains',
          hotspots: 'Hot cache entries',
          savings: 'Savings',
        },
        fields: {
          enabled: { label: 'Advanced cache switch', hint: 'When disabled, live traffic keeps using exact cache only.' },
          compressionEnabled: { label: 'Single-entry compression', hint: 'Responses larger than the threshold are stored in compressed form.' },
          costSavingEnabled: { label: 'Savings display', hint: 'Show local response cache and upstream Prompt Cache savings.' },
          promptCacheEnabled: { label: 'Upstream Prompt Cache display', hint: 'Show upstream read/write tokens and estimated savings.' },
          redisCapacity: { label: 'Redis capacity limit (MB)', hint: 'Valid range: 64 to {value} MB.' },
          memorySafeLimit: { label: 'System memory safe limit', hint: 'Calculated by the backend and shown as read-only.' },
          compressionThreshold: { label: 'Compression threshold (KB)', hint: 'Must not exceed the response cache size limit. Current limit is about {value} KB.' },
          responseLimit: { label: 'Response cache size limit', hint: 'Inherited from the cache config page and shown as read-only.' },
          evictionPolicy: { label: 'Eviction policy' },
          hotWindow: { label: 'Hotspot window' },
          hotThreshold: { label: 'Hotspot threshold (hits)', hint: 'Entries only become hotspots after reaching this hit count.' },
          grayScope: {
            title: 'Gray scope',
            hint: 'Limit advanced cache by API key, group, and model.',
            apiKeys: 'Gray API keys',
            apiKeyPlaceholder: 'Search by API key name',
            apiKeyEmpty: 'No matching API keys found',
            groups: 'Gray groups',
        ...
        validation: {
          redisCapacity: 'Redis capacity limit must be between 64 and {value} MB.',
          compressionThreshold: 'Compression threshold must be between 1 and {value} KB.',
          evictionPolicy: 'Eviction policy must be LRU, LFU, or W-TinyLFU.',
          hotWindow: 'Hotspot window must be one of 15m, 1h, 6h, or 24h.',
          hotThreshold: 'Hotspot threshold must be at least 1.',
        },
        hotWindows: { '15m': '15 minutes', '1h': '1 hour', '6h': '6 hours', '24h': '24 hours' },
        timeRanges: { '1h': 'Last 1 hour', '6h': 'Last 6 hours', '1d': 'Last 24 hours', '7d': 'Last 7 days', '31d': 'Last 31 days' },
        capacity: {
          currentUsed: 'Current usage',
          limit: 'Capacity limit',
          usageRate: 'Usage rate',
          safeLimit: 'Memory safe limit {value}',
          policy: 'Eviction policy',
          evictions: 'Recent evictions',
          lastEvictedAt: 'Last eviction time',
        },
        compression: {
          raw: 'Raw size',
          stored: 'Stored size',
          ...
          failed: 'Compression failures',
          decompressFailed: 'Decompression failures',
        },
        hotspots: {
          hint: 'The hotspot section only shows masked model, group, and API key information.',
          failedWithFallback: 'Hotspot refresh failed. The page is showing the last successful data.',
          rank: 'Rank',
          model: 'Hot model',
          group: 'Hot group',
          apiKey: 'Hot API key',
        ...
        savings: {
          localTokens: 'Local response cache saved tokens',
          localAmount: 'Local response cache saved amount',
          promptRead: 'Upstream Prompt Cache read tokens',
          promptWrite: 'Upstream Prompt Cache write tokens',
          promptAmount: 'Upstream Prompt Cache saved amount',
          totalAmount: 'Total estimated savings',
          priceMissingModels: 'Models missing prices: {models}',
          priceComplete: 'Pricing is complete',
        },
        empty: {
          hotspots: 'No hot cache entries yet',
          promptCache: 'No upstream Prompt Cache data yet',
        },
      },
      clearPage: {
        title: 'Cache Clear',
        description: 'Clear local response cache by scope. Dangerous operations require a second confirmation and repeated submissions are blocked while a request is in progress.',
        reset: 'Reset scope',
        submit: 'Clear cache',
        submitting: 'Clearing...',
        submitSuccess: 'Cache clear completed',
        submitPartial: 'Cache clear finished. Review the result details.',
        submitFailed: 'Failed to submit cache clear request',
        groupsLoadFailed: 'Failed to load groups',
        clearTypeTitle: 'Clear type',
        clearTypeHint: 'Actions follow the PRD-defined scopes and do not delete cache statistics.',
        scopeTitle: 'Clear scope',
        scopeHint: 'This page only exposes the FE-017 fields. Clearing all cache requires the confirmation text.',
        allHint: 'Clearing all cache is irreversible and must be confirmed again before submission.',
        expiredHint: 'Expired cache cleanup does not require extra scope fields and is suitable for routine maintenance.',
        previewTitle: 'Action preview',
        previewType: 'Clear type',
        previewScope: 'Scope',
        previewHint: 'Double-check the scope before submission. The backend clear endpoint runs immediately and returns matched/deleted counts.',
        resultTitle: 'Latest clear result',
        resultMatched: 'Matched keys',
        resultDeleted: 'Deleted keys',
        auditTitle: 'Clear audit history',
        auditHint: 'Shows recent cache clear records with filters for operator, clear type, result, and time range. Operations roles are read-only here.',
        auditRefresh: 'Refresh audits',
        auditRefreshing: 'Refreshing...',
        auditLoadFailed: 'Failed to load clear audits',
        auditEmpty: 'No clear audit records yet',
        auditMatchedShort: 'Matched',
        auditScopeAll: 'All cache',
        resultSuccess: 'Clear completed: deleted {deleted} cache keys out of {matched} matched keys.',
        resultPartial: 'Clear partially succeeded: deleted {deleted} cache keys out of {matched} matched keys. Reason: {reason}',
        resultFailed: 'Clear failed: {reason}',
        confirmTitle: 'Confirm cache clear',
        confirmDescription: 'This action cannot be undone. Review the scope one more time before submitting.',
        confirmInputLabel: 'Enter the confirmation text',
        confirmInputPlaceholder: 'Type: 确认清理',
        confirmSubmit: 'Confirm clear',
        auditColumns: {
          id: 'Audit ID',
          operator: 'Operator',
          createdAt: 'Time',
        ...
        auditValidation: {
          timeRequired: 'Start time and end time must both be set for audit filters.',
          timeInvalid: 'The audit filter time is invalid.',
          timeOrder: 'The audit filter start time must be earlier than the end time.',
          timeRange: 'The audit filter time range cannot exceed 31 days.',
        },
        fields: {
          platforms: 'Platforms',
          models: 'Models',
          modelsPlaceholder: 'Enter a model name and press Enter or Add',
          modelsEmpty: 'No model has been added yet',
          modelsHint: 'There is no dedicated model search endpoint in this repo yet, so models are added manually by name for now.',
          groups: 'Groups',
          groupsHint: 'Multiple groups can be selected. Only the currently selected group IDs are submitted.',
          apiKeys: 'API Keys',
          apiKeysPlaceholder: 'Search by API key name',
          apiKeysEmpty: 'No matching API keys were found',
          apiKeysHint: 'The current search endpoint returns the key name and ID, not the raw key value.',
          startTime: 'Start time',
          endTime: 'End time',
        },
        types: {
        ...
        typeHints: {
          expired: 'Clear expired cache only and require no extra conditions.',
          byPlatform: 'Clear cache for one or more selected platforms.',
          byModel: 'Clear cache by model name.',
          byGroup: 'Clear cache by selected groups.',
          byApiKey: 'Clear cache by selected API keys.',
          byTime: 'Clear cache by time range, capped at 31 days.',
          all: 'Clear the local response cache without touching the statistics data.',
        },
        validation: {
          default: 'Fix the scope configuration before submitting.',
          platforms: 'Select at least one platform.',
          models: 'Add at least one model.',
          groups: 'Select at least one group.',
          apiKeys: 'Select at least one API key.',
          timeRequired: 'Select both start time and end time.',
          timeInvalid: 'The selected time is invalid.',
          timeOrder: 'The start time must be earlier than the end time.',
          timeRange: 'The time range cannot exceed 31 days.',
        },
      },
    },
    settings: {
      ...
      features: {
        channelMonitor: {
          title: 'Channel Monitor',
          description: 'Periodically probe configured channels for admin availability and latency checks. Customer visibility is controlled separately.',
          ...
          publicEnabled: 'Show Channel Status to customers',
          publicEnabledHint: 'When off, the customer sidebar hides Channel Status and user APIs return empty results; admins can still view monitors.',
        },
        availableChannels: {
          title: 'Available Channels',
          description: 'Show signed-in customers the channels, groups, models, and pricing they can access.',
          configureLink: 'Configure channel pricing in Channel Management > Channel Pricing',
          enabled: 'Show Available Channels',
          enabledHint: 'When off, Available Channels is hidden from the customer sidebar; existing channel and pricing data is preserved.',
        },
        modelSquare: {
          title: 'Model Square',
        ...
        openaiRemoteCompactionV2: {
          title: 'OpenAI Remote Compaction V2',
          description: 'Controls the native Remote Compaction V2 protocol for all customers.',
          enabled: 'Enable Remote Compaction V2',
          enabledHint: 'When off, only the V2 protocol is rejected. The legacy /responses/compact path stays available for rollback.',
        },
        groupUsageRollup: {
          title: 'Group Usage Rollup',
          description: 'Controls the group usage rollup reader and background worker.',
          enabled: 'Enable Group Usage Rollup',
          enabledHint: 'When off, group usage reads use realtime data and the worker pauses. Existing rollups and invalidations are retained for recovery.',
        },
        salesPricingResolver: {
          title: 'Sales Pricing Resolver',
          description: 'Controls whether sales pricing participates in actual request billing. The current server state appears on the right.',
          currentEnabled: 'Current: enabled',
          currentDisabled: 'Current: disabled',
          dangerWarning: 'Danger: this change immediately affects sales-price resolution and billing for new requests. Confirm the rollback scope and provide an auditable reason before saving.',
          enabled: 'Enable Sales Pricing Resolver',
          enabledHint: 'Both enabling and disabling are billing changes and require a reason.',
          reason: 'Sales pricing change reason',
          reasonPlaceholder: 'Describe the reason, impact scope, or rollback basis',
          reasonHint: 'Submitted only when the state changes; must be 5–500 characters.',
          reasonValidation: 'A 5–500 character reason is required to change sales pricing state.',
        },
        openaiTeamLinkedResolver: {
          title: 'OpenAI Team Linked Resolver',
          description: 'Controls cross-account Team workspace handling, probing, and dedicated errors after a workspace is deactivated.',
          currentEnabled: 'Current: enabled',
          currentDisabled: 'Current: disabled',
          dangerWarning: 'Turning this off stops new Team linkage and automatic probes only. Existing Team protection records remain in place so current pauses cannot be bypassed.',
          enabled: 'Enable Team Linked Resolver',
          enabledHint: 'This immediately changes handling of new Team workspace deactivations and requires a reason.',
          reason: 'Team linkage change reason',
          reasonPlaceholder: 'Describe the reason, impact scope, or rollback basis',
          reasonHint: 'Submitted only when the state changes; must be 5–500 characters.',
          reasonValidation: 'A 5–500 character reason is required to change Team linkage state.',
        },
        riskControl: {
          title: 'Risk Control',
      ...
      registration: {
        ...
        domainLimit: 'Registration domain limit',
        domainLimitHint: 'Limit accounts per email domain; inactive when disabled.',
        domainLimitUnit: 'accounts/domain',
        xSearchPrice: 'x_search price per request',
        xSearchPriceHint: 'Positive USD decimal, up to 10 fractional digits. Leave empty to keep x_search unpriced.',
        xSearchPriceLoadError: 'x_search price is temporarily unavailable; other settings can still be edited.',
        xSearchPriceSaveError: 'x_search price could not be saved. Your other settings were kept.',
      ...
      customMenu: {
        ...
        description: 'Add custom pages to the sidebar navigation. Each page can be visible to regular users or administrators.',
      ...
      balanceNotify: {
        title: 'Balance Low Notification',
        description: 'Scan user balances every 5 minutes and email the registered address when balance is below the threshold',
        enabled: 'Enable Balance Low Notification',
        threshold: 'Global Threshold',
        thresholdHint: 'This global threshold applies to all users. An email is sent when balance is below this amount',
        thresholdPlaceholder: 'Enter amount',
        ...
        excludedUsersHint: 'Users in this list will not receive low balance emails.',
        searchPlaceholder: 'Search email or username to exclude',
        excludedUsersEmpty: 'No excluded users',
      },
      quotaNotify: {
