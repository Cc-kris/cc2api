  ...
  admin: {
    ...
    settings: {
      ...
      customMenu: {
        ...
        url: 'Page URL',
        urlPlaceholder: 'https://example.com/page or md:api-key-guide',
        urlHint: 'Use a full http(s) URL for an external page, or md:slug to render the Markdown content below as an internal page.',
