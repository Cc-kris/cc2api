  ...
  admin: {
    ...
    accounts: {
      ...
      openai: {
        ...
        codexImageGenerationBridgeDesc:
          'Account policy takes precedence over channel and global settings. Controls whether eligible Codex /responses requests automatically receive the image_generation tool; standalone image-generation endpoints are unaffected.',
        ...
        codexImageGenerationBridgeEnabledDesc: 'Allow image tool injection for eligible Codex /responses requests.',
    ...
    settings: {
      ...
      customMenu: {
        ...
        url: 'Page URL',
        urlPlaceholder: 'https://example.com/page, /seedance-video-guide.html, or md:api-key-guide',
        urlHint: 'Use a full http(s) URL for an external page, a / site-relative path for an internal page, or md:slug to render the Markdown content below as an internal page.',
