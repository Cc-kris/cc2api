  ...
  admin: {
    ...
    channels: {
      ...
      form: {
        ...
        codexImageGenerationBridgeHint: 'When enabled, only explicit Codex /responses image-generation requests receive the image_generation tool. Plain text requests are not injected.',
    ...
    accounts: {
      ...
      openai: {
        ...
        codexImageGenerationBridgeDesc:
          'Account policy takes precedence over channel and global settings. Only controls whether explicit image-generation requests through the Codex /responses text endpoint receive the image_generation tool; standalone image-generation endpoints are unaffected.',
        ...
        codexImageGenerationBridgeEnabledDesc: 'Allow image tool injection for explicit Codex /responses image requests.',
