export default {
  ...
  auth: {
    agreement: {
      ...
      mustAgreeTitle: '继续前需要先同意最新条款。',
      mustAgreeDescription: '未同意前可以先填写账号密码，但提交登录前需要同意；快捷登录会保持禁用。',
      viewTerms: '查看条款',
      updateTitle: '条款更新通知',
  ...
  keys: {
    ...
    useKeyModal: {
      ...
      openai: {
        description: '只需将以下内容写入 Codex CLI 配置目录中的 config.toml 文件即可使用 API。',
        configTomlHint: '只需修改 config.toml，将 API 密钥写入 experimental_bearer_token',
        note: '请确保配置目录存在。macOS/Linux 用户可运行 mkdir -p ~/.codex 创建目录，然后将内容写入 ~/.codex/config.toml。',
        noteWindows:
          '按 Win+R，输入 %userprofile%\\.codex 打开配置目录。如目录不存在，请先手动创建，然后将内容写入 config.toml。'
      },
      cliTabs: {
      ...
      opencode: {
        ...
        hint: '配置文件路径：~/.config/opencode/opencode.json（或 opencode.jsonc），不存在需手动创建。本示例使用 ccai provider，并把 API Key 直接写入配置文件，不需要再走 /connect。'
      }
    },
  ...
  videoGeneration: {
    ...
    selectApiKey: '请选择 Seedance API Key',
    noApiKeys: '当前没有可用的 Seedace 分组 API Key。',
    modelLabel: '模型选择',
    selectModel: '请选择模型',
    resolutionLabel: '分辨率',
    selectResolution: '请选择分辨率',
    aspectRatioLabel: '视频比例',
    durationLabel: '视频时间',
    audioLabel: '是否生成声音',
    referenceImages: '参考图',
    referenceImagesHint: '非必填，小于 9 张',
    uploadReferenceImages: '上传参考图',
    frameReference: '首尾帧参考',
    uploadFirstFrame: '上传首帧',
    uploadLastFrame: '上传尾帧',
    referenceVideos: '参考视频',
    referenceVideosHint: '非必填，小于 3 个，每个小于 15 秒',
    uploadReferenceVideos: '上传参考视频',
    referenceAudios: '参考音频',
    referenceAudiosHint: '非必填，最多 3 个，支持 MP3/WAV/M4A 等格式',
    uploadReferenceAudios: '上传参考音频',
    audioNeedsImage: '上传参考音频后，需要至少上传 1 张参考图。',
    dialogTitle: '视频生成对话',
    dialogDescription: '提交后自动轮询生成结果，生成完成后提供下载按钮。',
    newConversation: '新对话',
    history: '历史记录',
    emptyHistory: '暂无生成记录',
    generationCount: '{count} 次',
    lastGenerated: '最后生成 {time}',
    emptyConversation: '选择 API Key 和模型后，在底部输入内容。',
    polling: '正在轮询生成结果',
    download: '下载',
    expiryWarning: '该视频有效期为 24 小时，请及时下载。',
    promptPlaceholder: '请输入视频生成内容，作为 prompt 提交',
    submit: '提交',
    generating: '生成中',
    generated: '已生成视频',
    ...
    remove: '移除',
    models: {
      domestic: '国内 - Seedance 2.0',
      international: '国际 - Seedance 2.0',
      internationalFast: '国际 - Seedance 2.0 Fast'
    },
    frameModes: {
      none: '不使用',
      startFrame: '首帧参考',
    ...
    errors: {
      historyLoadFailed: '视频生成历史加载失败',
      historySaveFailed: '视频生成历史保存失败',
      apiKeysLoadFailed: 'API Key 加载失败',
      apiKeyRequired: '请选择 API Key',
      modelRequired: '请选择模型',
      resolutionRequired: '请选择分辨率',
      unsupportedResolution: '当前模型不支持该分辨率',
      aspectRatioRequired: '请选择视频比例',
      durationRequired: '请选择视频时间',
      promptRequired: '请输入视频生成内容',
      tooManyImages: '参考图不能超过 9 张',
      tooManyVideos: '参考视频不能超过 3 个',
      tooManyAudios: '参考音频不能超过 3 个',
      videoTooLong: '参考视频必须小于 15 秒',
      audioImageRequired: '上传参考音频时，需要至少上传 1 张参考图',
      firstFrameRequired: '当前模式需要上传首帧图',
      lastFrameRequired: '当前模式需要上传尾帧图',
      upstreamTaskMissing: '上游未返回任务 ID',
      upstreamFailed: '上游返回生成失败',
      pollingTimeout: '轮询超时，未获取到视频链接，请稍后重试',
      downloadFailed: '视频下载失败',
      imageTypeInvalid: '参考图仅支持图片格式',
      audioTypeInvalid: '参考音频仅支持 MP3、WAV、M4A 等格式',
      fileReadFailed: '文件读取失败',
      videoReadFailed: '参考视频读取失败'
    }
  },
  usage: {
    title: '使用记录',
    description: '查看和分析您的 API 使用历史',
    tabs: { label: '用量视图', details: '明细', errors: '错误请求', ranking: '用户 Token 排名', errorsHint: '打开统一错误视图，查看失败请求和 SLA 分类。', openErrors: '打开错误请求' },
    tokenRanking: { title: '用户 Token 排名', range: '{start} 至 {end}', user: '用户', failed: 'Token 排名加载失败', empty: '该范围暂无 Token 用量' },
    costDetails: '成本明细',
  ...
  modelSquare: {
    title: '模型广场',
    description: '按公开分组查看当前可用模型、计费方式、原价和倍率价。',
    publicGroups: '公开分组',
    selectGroup: '选择分组',
    searchGroups: '搜索分组',
    searchModels: '搜索当前分组的模型',
    clearSearch: '清空搜索',
    updatedAt: '目录更新于 {value}',
    modelCount: '{count} 个模型',
    custom: '专属',
    defaultMultiplier: '默认倍率 {value}×',
    myMultiplier: '我的倍率 {value}×',
    multiplierPrice: '倍率价',
    originalPrice: '原价',
    free: '免费',
    modelTable: '模型价格列表',
    ...
    modelCopied: '模型名称已复制',
    viewFast: '查看 Fast 价格',
    viewTiers: '查看 {count} 个阶梯',
    tokens: 'Token',
    allLoaded: '已加载全部模型',
    catalogChanged: '模型目录已更新，正在重新加载。',
    loadFailed: '模型广场加载失败',
    noGroups: '暂无公开分组',
    noGroupsDescription: '当前没有可展示的公开或专属分组。',
    noModels: '当前分组暂时没有可用模型',
    noModelsDescription: '可以切换其他分组查看。',
    noSearchResults: '当前分组没有匹配模型',
    noSearchResultsDescription: '清空搜索词后查看全部模型。',
    columns: {
      name: '模型名称',
      billingMode: '计费方式',
      input: '输入',
    ...
    units: {
      ...
      per_1m_cache_tokens: '1M 缓存 Token',
      per_request: '次',
      per_image: '张',
      per_second: '秒'
    }
  ...
  admin: {
    ...
    users: {
      ...
      balanceFilter: {
        ...
        minRequired: '请输入最小余额',
        maxRequired: '请输入最大余额',
        invalidAmount: '请输入最多 4 位小数的金额，可为负数',
        maxMustBeGteMin: '最大余额必须大于或等于最小余额'
      },
      searchGroups: '搜索分组...',
      fuzzySearch: '模糊搜索',
      statusFilter: '状态筛选',
      ...
      bulk: {
        ...
        addTags: '批量打标签',
        addTagsTitle: '批量打标签',
        addTagsHint: '给选中的 {count} 个用户追加标签，不会清空已有标签。',
        noTags: '暂无标签，请先在标签管理中创建',
        tagRequired: '请选择至少一个标签',
        disableConfirm: '确定禁用选中的 {count} 个用户吗？管理员账号会返回失败，不会被禁用。',
        deleteConfirm: '确定删除选中的 {count} 个用户吗？此操作无法撤销，管理员账号会返回失败。',
        partialSuccess: '已成功 {success} 个，失败 {failed} 个',
        deleteSuccess: '已删除 {count} 个用户',
        disableSuccess: '已禁用 {count} 个用户',
        tagSuccess: '已给 {count} 个用户添加标签'
      },
    ...
    groups: {
      ...
      videoPricing: {
        title: 'Grok 视频生成计费',
        description: '按视频分辨率配置每秒基础单价，留空时使用 xAI 官方默认价格',
        independentMultiplier: '视频倍率独立',
        videoMultiplier: '视频独立倍率',
        modeHint: '视频费用 = 每秒价格 × 视频时长 × 生成数量 × 有效倍率。关闭独立倍率时使用当前分组有效倍率。'
      },
      claudeCode: {
    ...
    channelMonitor: {
      ...
      importAccountsSuccess: '已新增 {created} 个上游监控，跳过 {duplicate} 个重复上游、{unsupported} 个不可转换账号，共 {total} 个账号。',
      importAccountsFailed: '一键新增上游监控失败',
      ...
      form: {
        ...
        mode: '监控模式',
        modeActive: '主动探测',
        modeActiveHint: '按计划请求上游并记录延迟与状态。',
        modePassive: '被动遥测',
        modePassiveHint: '不主动发送探测请求，根据实际流量判断状态。',
        modeQuota: '配额快照',
        modeQuotaHint: '不主动发送探测请求，使用可用的账号配额快照。',
        accountId: '绑定账号 ID',
        accountIdPlaceholder: '可选，上游账号 ID',
        accountIdHint: '被动遥测和配额快照采集启用后，将使用此账号作为数据来源。',
        accountSearchPlaceholder: '按账号名称搜索（300ms 防抖）',
        apiMode: 'OpenAI 协议',
    ...
    accounts: {
      ...
      batchTest: {
        ...
        statusPass: '通过',
        statusError: '出错',
        statusErrorWithCode: '出错 {code}',
        done: '测试完成：共 {total} 个，通过 {passed} 个，失败 {failed} 个',
        failed: '批量测试失败'
      },
      viewColumns: '列显示',
      ...
      teamWorkspace: {
        title: 'OpenAI Team 工作区暂时停止调度',
        refresh: '刷新状态',
        refreshing: '刷新中',
        affected: '工作区：{teamId}；影响账号：{accountIds}。',
        none: '无',
        probeAt: '自动恢复探测时间：{time}。',
        recoveryHint: '可在账号列表执行“测试账号”发起一次受控恢复探测。',
        loadFailed: '无法获取 Team 工作区状态。',
        retry: '重试'
      },
      tempUnschedulable: {
        title: '临时不可调度',
      ...
      bulkEdit: {
        ...
        resultSummary: '批量结果：成功 {success} 个，未变化 {unchanged} 个，失败 {failed} 个',
        copyFailed: '复制失败账号',
        failedCopied: '失败账号 ID 已复制',
        upstreamSeparateOnly: '上游倍率必须单独批量更新，不能与其他字段同时提交',
        upstreamConfirmTitle: '确认批量修改上游倍率',
        upstreamConfirmMessage: '将影响 {count} 个账号。原值分布：{distribution}；新倍率：{value}。保存后仅影响此后新选中这些账号的请求。',
        distributionUnavailable: '当前筛选范围由后端逐账号比较',
        failed: '批量更新失败',
      ...
      openai: {
        ...
        codexIdentityMode: 'Codex 身份策略',
        codexIdentityModeDesc: '仅对 OpenAI OAuth 生效。统一控制 HTTP、WebSocket 和连接测试使用的客户端身份字段；不会生成或保存令牌。',
        codexIdentityModeDisabled: '关闭（保持旧行为）',
        codexIdentityModeDevice: '设备',
        codexIdentityModeSession: '设备 + 会话',
        codexIdentityModeFull: '完整（设备 + 会话 + User-Agent）',
      ...
      actualModel: '实际模型',
      addMapping: '添加映射',
      fetchUpstreamModels: '获取上游支持模型',
      fetchingUpstreamModels: '正在获取上游支持模型...',
      fetchUpstreamModelsSuccess: '已填充 {count} 个上游支持模型',
      fetchUpstreamModelsEmpty: '上游未返回可用模型',
      fetchUpstreamModelsDisabledByPassthrough: '已开启自动透传：模型映射不会生效，无法获取并填充映射。',
      ...
      upstreamPrepaidAmount: '上游预存金额',
      upstreamPrepaidAmountHint: '美元单位。账号产生花费后会实时扣减此金额。',
      upstreamWarningAmount: '预警金额',
      upstreamWarningAmountHint: '美元单位。当上游预存金额低于该金额时触发预警。',
      upstreamNotifyEnabled: '低于预警金额时发送邮件通知',
      upstreamPrepaidAmountRequired: '请输入上游预存金额',
      upstreamWarningAmountRequired: '请输入预警金额',
      upstreamWarningAmountMustBeLess: '预警金额必须小于上游预存金额',
      ...
      billingRateMultiplierHint: '用于账号额度、统计和告警，不影响客户售价与采购成本',
      upstreamCostMultiplier: '上游倍率',
      upstreamCostMultiplierHint: '用于采购成本和利润计算，不影响客户扣费',
      upstreamCostMultiplierUnconfigured: '未配置',
      upstreamCostMultiplierInvalid: '上游倍率必须为 0 至 9999.9999，最多 4 位小数',
      upstreamCostMultiplierChangeReason: '变更原因',
      upstreamCostMultiplierChangeReasonHint: '请填写 5 至 500 个字符，说明本次上游倍率调整依据',
      upstreamCostMultiplierChangeNotice: '原倍率：{oldValue}；新倍率：{newValue}。保存后仅影响此后新选中该账号的请求。',
      upstreamCostMultiplierUpdated: '上游倍率已更新，仅影响此后新选中该账号的请求。',
      upstreamMultiplierHistory: '上游倍率历史',
      upstreamMultiplierHistoryEmpty: '暂无倍率变更记录',
      upstreamMultiplierHistoryLoadFailed: '倍率历史加载失败',
      upstreamMultiplierEffectiveAt: '生效时间',
      upstreamMultiplierOldValue: '原倍率',
      upstreamMultiplierNewValue: '新倍率',
      upstreamMultiplierOperator: '操作人',
      upstreamMultiplierReason: '变更原因',
      upstreamMultiplierViewAll: '查看全部',
      upstreamMultiplierPreviousPage: '上一页',
      upstreamMultiplierNextPage: '下一页',
      expiresAt: '过期时间',
    ...
    ops: {
      ...
      clientErrors: '客户端错误',
      platformErrors: '平台错误',
      platformSlaErrors: '影响平台 SLA 的错误',
      upstreamLimited: '上游限流/资源风险',
      businessLimitedDetails: '业务限制',
      ...
      errorReasons: {
        ...
        quotaExceeded: '额度或用量限制',
        upstreamRateLimited: '上游限流',
        upstreamOverloaded: '上游过载',
        upstreamTimeout: '上游超时',
        upstreamError: '上游错误',
        routingFailed: '路由失败或无可用账号',
        platformError: '平台内部错误',
        clientAuthError: '客户端认证错误',
        clientRequestError: '客户端请求错误',
        other: '其他错误'
      },
      // Error Log
      errorLog: {
      ...
      incidentOverview: {
        title: '运维事故总览',
        description: '面向当前窗口的事故状态、影响范围与 AI 分析入口。',
        autoRefresh: '{seconds} 秒后自动刷新',
        manualAnalysis: '手动 AI 分析',
        lastUpdated: '最近刷新',
        currentWindow: '当前窗口',
        loadFailed: '加载事故总览失败',
        statusCard: '当前状态',
        riskScore: '健康风险分数',
        viewScoreReasons: '查看分数原因',
        scoreReasonsTitle: '分数原因',
        scoreReasonEmpty: '暂无异常原因',
        primarySummary: '主要问题摘要',
        viewDetails: '查看详情',
        noDetails: '暂无可查看详情',
        noSummary: '暂无需要处理的问题',
        noRecommendedActions: '暂无额外处理建议。',
        impactTitle: '影响范围',
        impactDescription: '优先帮助运维确认当前影响面与处理优先级。',
        finalFailures: '最终失败数',
        recoveredFluctuations: '已恢复波动数',
        affectedUsers: '影响用户数',
        affectedApiKeys: '影响 API Key 数',
        affectedModels: '影响模型',
        affectedAccounts: '影响上游账号',
        recoveredHint: '点击查看相关错误',
        userImpactHint: '点击查看相关错误',
        apiKeyImpactHint: '点击查看相关错误',
        none: '无',
        unknownModel: '未知模型',
        unknownAccount: '未知上游账号',
        latestAnalysisTitle: '最近 AI 分析',
        latestAnalysisDescription: '查看最近一次分析结论，或针对当前筛选窗口发起新的 AI 分析。',
        openAnalysis: '打开分析',
        noAnalysis: '暂无 AI 分析',
        analysisExpired: '分析已过期',
        analysisDialogTitle: 'AI 分析详情',
        analysisLoading: '正在加载 AI 分析详情...',
        ...
        noQuickFilters: '当前没有可用的快捷筛选。',
        emptyTitle: '暂无事故总览数据',
        emptyDescription: '当前筛选窗口下没有可展示的事故聚合结果。',
        ...
        analysisDisabled: {
          ...
          timeTooLarge: '手动 AI 分析时间范围不能超过 24 小时。'
        },
        timeRanges: {
          '1m': '近 1 分钟',
          '5m': '近 5 分钟',
      ...
      aiAnalysis: {
        ...
        history: {
          title: '最近 AI 分析',
          description: '展示所有已触发过的 AI 分析，可点击查看历史详情。',
          empty: '暂无 AI 分析记录',
          selectHint: '选择左侧记录查看分析详情',
          summary: '摘要',
          rootCause: '根因',
          actions: '处置建议',
          loadFailed: '加载 AI 分析历史失败'
        },
        fields: {
          enabled: '启用 AI 分析',
      ...
      unifiedErrorDetail: {
        ...
        viewLogs: '查看日志',
        manualAnalysis: '手动 AI 分析',
        invalidId: '错误详情 ID 无效。',
        emptySummary: '暂无问题摘要',
        unknown: '未知',
        unknownUser: '未知用户',
        unknownApiKey: '未知 API Key',
        ungrouped: '未分组',
        hiddenUpstreamAccount: '已隐藏',
        unclassified: '未分类',
        unconfirmed: '未确认',
        notAnalyzed: '未分析',
        noReason: '暂无分类依据',
        ...
        fields: {
          ...
          upstreamEndpoint: '上游端点',
          errorCategory: '错误大类',
          errorSubcategory: '错误子类',
          clientSubcategory: '客户端细分',
          confidence: '分类置信度',
          statusCode: '状态码',
          clientStatusCode: '客户端状态码',
          errorOwner: '归属方',
          errorSource: '来源',
      ...
      alertEvents: {
        ...
        detail: {
          ...
          empty: '暂无详情',
          loadFailed: '加载告警详情失败',
          statusActionsTitle: '状态操作',
          statusActionsHint: '支持确认、处理中、关闭和静默，提交后会立即刷新当前事件状态。',
          actionNoteLabel: '备注说明',
          actionNotePlaceholder: '填写确认说明、处理说明或关闭原因（选填）',
          processingActionLabel: '处理动作',
          processingActionPlaceholder: '标记处理中时可填写预计处理动作（选填）',
          acknowledge: '确认',
          acknowledgeSuccess: '已确认该告警',
          acknowledgeFailed: '确认告警失败',
          markProcessing: '标记处理中',
          processingSuccess: '已标记为处理中',
          processingFailed: '标记处理中失败',
          close: '关闭告警',
          closeSuccess: '已关闭该告警',
          closeFailed: '关闭告警失败',
      ...
      email: {
        ...
        minSeverity: '最低级别',
        minSeverityAll: '全部级别',
        healthScoreThreshold: '预警健康分值',
        healthScoreIntervalMinutes: '提醒间隔（分钟）',
        ...
        validation: {
          ...
          healthScoreThresholdRange: '预警健康分值必须在 1 到 100 之间',
          healthScoreIntervalRange: '提醒间隔必须在 1 到 1440 分钟之间',
    ...
    settings: {
        ...
        aiAnalysisConfigHint: '配置运维监控 AI 分析使用的接口、模型、自动分析等级和手动分析开关。',
        aiAnalysisConfigEnabled: '已启用',
        aiAnalysisConfigDisabled: '已关闭',
        aiAnalysisConfigNotLoaded: '未加载',
        aiAnalysisNoAutoLevels: '不自动分析',
        aiAnalysisStatus: '状态',
        aiAnalysisModel: '接口 / 模型',
        aiAnalysisEndpoint: '服务地址',
        aiAnalysisAutoLevels: '自动分析等级',
        aiAnalysisTest: '测试连接',
        aiAnalysisTesting: '测试中...',
        aiAnalysisTestSuccess: 'AI 分析连接测试成功',
        aiAnalysisTestFailed: 'AI 分析连接测试失败',
        aiAnalysisOpenConfig: '打开 AI 配置',
        enableAlert: '开启预警',
      ...
      tooltips: {
        ...
        userSuccessRate: '用户最终成功比例，包含客户端错误、业务限制和上游限流等用户体感失败。',
        goroutines:
    ...
    cacheManagement: {
      ...
      export: '导出缓存统计',
      exporting: '导出中...',
      exportSuccess: '缓存统计导出成功',
      exportFailed: '缓存统计导出失败',
      exportNoPermission: '当前账号无权限导出缓存统计。',
      exportHint: '仅平台所有者、运营可导出缓存统计 CSV；导出失败时会展示后端返回原因。',
      exportHintReadonly: '当前账号可查看缓存统计相关入口，但无权限导出 CSV。',
      resetChanges: '撤销未保存修改',
      resetDefaultValues: '恢复安全默认值',
      readonlyNotice: '当前账号仅可查看缓存配置，不能保存修改。',
      validationTitle: '保存前请先修正以下问题：',
      ...
      sectionCards: {
        ...
        pending: '后续任务',
        configTitle: '缓存配置',
        configDescription: '本次交付：开关、TTL、大小、模型名单、保存校验。',
        statsTitle: '缓存统计',
        statsDescription: '已接入汇总卡、模型表、绕过原因和写入跳过原因。',
        maintenanceTitle: '缓存维护',
        maintenanceDescription: '缓存清理、审计列表和范围操作将在后续任务接入。',
        advancedTitle: '高级策略',
      ...
      switchesHint: '全局开关关闭后，所有平台都不会读写本地响应缓存。',
      limitsHint: '保存前会按后端同口径校验 TTL、大小和 temperature 阈值。',
      modelsHint: '支持逐行或逗号分隔输入；空行会自动忽略，重复模型会自动去重。',
      scopeTitle: '缓存范围',
      scopeValue: 'API Key + Group + Platform + Model + Endpoint + Body',
      scopeHint: '缓存范围为系统固定规则，本期不允许跨用户共享，也不允许在页面中修改。',
      bypassHeaderTitle: '客户端绕过 Header',
      defaults: {
        ttl: '默认 TTL',
        temperature: '默认 temperature 阈值',
        requestLimit: '默认请求体上限',
        responseLimit: '默认响应体上限',
      },
      fields: {
        globalEnabled: {
          label: '全局缓存开关',
          hint: '关闭后所有平台都不读取也不写入本地响应缓存。',
        },
        platformHint: '单独控制该平台是否启用缓存。',
        ttl: {
          label: 'TTL（秒）',
          hint: '合法范围 60～86400 秒。修改后仅影响新写入缓存。',
        },
        temperature: {
          label: 'temperature 阈值',
          hint: '合法范围 0～2，高于阈值的请求会绕过缓存。',
        },
        maxRequestBytes: {
          label: '请求体上限（字节）',
          hint: '当前约 {value}，合法范围 1024～5242880 字节。',
        },
        maxResponseBytes: {
          label: '响应体上限（字节）',
          hint: '当前约 {value}，合法范围 1024～10485760 字节。',
        },
        allowlist: {
          label: '模型白名单',
          placeholder: '例如：\ngpt-4.1\nclaude-3-7-sonnet-*',
          hint: '为空表示不限制模型；支持精确匹配和通配符。',
        },
        blocklist: {
          label: '模型黑名单',
          placeholder: '例如：\ngpt-4o-audio-*\ngemini-1.5-pro-exp',
          hint: '命中黑名单会强制绕过缓存，且不能与白名单重复。',
        },
      },
      validation: {
        ttl: 'TTL 必须在 60 到 86400 秒之间。',
        maxRequestBytes: '请求体上限必须在 1024 到 5242880 字节之间。',
        maxResponseBytes: '响应体上限必须在 1024 到 10485760 字节之间。',
        maxTemperature: 'temperature 阈值必须在 0 到 2 之间。',
        modelOverlap: '模型白名单与黑名单不能重复：{model}',
      },
      nav: {
        home: '管理首页',
        config: '缓存配置',
      ...
      advancedPage: {
        title: '高级缓存策略',
        description: '集中管理高级缓存开关、灰度范围与容量/压缩/热点/成本统计。',
        loadFailed: '高级缓存配置加载失败',
        saveFailed: '高级缓存配置保存失败',
        saved: '高级缓存配置已保存',
        statsLoadFailed: '高级缓存统计加载失败',
        readonlyNotice: '当前账号仅可查看高级缓存统计，不能保存配置。',
        noPermission: '当前账号无权限执行此操作。',
        hiddenAmount: '无权限查看金额',
        priceMissing: '价格缺失',
        actions: {
          backToCache: '返回缓存管理',
          refresh: '刷新页面',
        ...
        alerts: {
          disabled: '高级策略未启用，当前线上请求使用精确缓存。',
          fallback: '已回退到精确缓存。回退原因：{reason}',
        },
        fallbackReasons: {
          disabled: '高级缓存未启用',
        },
        form: {
          title: '高级配置表单',
          hint: '总开关关闭时仅保存配置，不影响线上请求；灰度范围为空时不得对正式请求生效。',
        },
        filters: {
          title: '统计筛选',
          hint: '容量、压缩、热点和成本四个区域共用当前筛选条件。',
          timeRange: '时间范围',
          hotspotLimit: '热点数量上限',
          platform: '平台',
          group: '分组',
          model: '模型',
          modelPlaceholder: '输入模型名称筛选',
          allPlatforms: '全部平台',
          allGroups: '全部分组',
          apply: '刷新统计',
          reset: '重置筛选',
        ...
        info: {
          title: '当前状态',
          grayScope: '灰度范围',
          grayScopeValue: 'API Key {apiKeys} 个，分组 {groups} 个，模型 {models} 个',
          responseLimit: '响应体缓存上限',
          updatedAt: '统计更新时间',
        },
        summary: {
          mode: '高级缓存开关',
          grayScopeEmpty: '灰度范围为空时不会对正式请求生效。',
          capacity: 'Redis 容量上限',
          safeLimit: '系统安全上限 {value} MB',
          compression: '单条缓存压缩',
          compressionThreshold: '压缩阈值 {value} KB',
          updatedAt: '统计更新时间',
        },
        sections: {
          capacity: '容量控制区',
        ...
        fields: {
          enabled: { label: '高级缓存总开关', hint: '关闭后线上流量继续走精确缓存。' },
          compressionEnabled: { label: '单条缓存压缩', hint: '超过阈值的响应体将使用压缩存储。' },
          costSavingEnabled: { label: '成本节省展示', hint: '展示本地响应缓存与上游 Prompt Cache 的节省信息。' },
          promptCacheEnabled: { label: '上游 Prompt Cache 展示', hint: '展示上游 read/write tokens 与节省金额。' },
          redisCapacity: { label: 'Redis 缓存容量上限（MB）', hint: '合法范围 64～{value} MB。' },
          memorySafeLimit: { label: '系统可用内存安全上限', hint: '后端自动计算，只读展示。' },
          compressionThreshold: { label: '压缩触发阈值（KB）', hint: '不得超过响应体缓存上限，当前上限约 {value} KB。' },
          responseLimit: { label: '响应体缓存上限', hint: '沿用缓存配置页的响应体缓存上限，只读展示。' },
          evictionPolicy: { label: '淘汰策略' },
          hotWindow: { label: '热点识别窗口' },
          hotThreshold: { label: '热点阈值（命中次数）', hint: '达到阈值后才会进入热点缓存统计。' },
          grayScope: {
            title: '灰度范围',
            hint: '可按 API Key、分组、模型限制高级缓存生效范围。',
            apiKeys: '灰度 API Key',
            apiKeyPlaceholder: '输入 API Key 名称搜索',
            apiKeyEmpty: '未找到匹配的 API Key',
            groups: '灰度分组',
            groupsEmpty: '暂无可选分组',
            models: '灰度模型',
        ...
        validation: {
          redisCapacity: 'Redis 缓存容量上限必须在 64 到 {value} MB 之间。',
          compressionThreshold: '压缩触发阈值必须在 1 到 {value} KB 之间。',
          evictionPolicy: '淘汰策略必须是 LRU、LFU 或 W-TinyLFU。',
          hotWindow: '热点识别窗口必须是 15m、1h、6h、24h 之一。',
          hotThreshold: '热点阈值必须大于等于 1。',
        },
        hotWindows: { '15m': '15 分钟', '1h': '1 小时', '6h': '6 小时', '24h': '24 小时' },
        timeRanges: { '1h': '最近 1 小时', '6h': '最近 6 小时', '1d': '最近 24 小时', '7d': '最近 7 天', '31d': '最近 31 天' },
        capacity: {
          currentUsed: '当前容量',
          limit: '容量上限',
          usageRate: '容量使用率',
          safeLimit: '系统安全上限 {value}',
          policy: '淘汰策略',
          evictions: '最近淘汰次数',
          lastEvictedAt: '最近淘汰时间',
        },
        compression: {
          raw: '压缩前大小',
          stored: '压缩后大小',
          ...
          savedRate: '压缩节省率',
          failed: '压缩失败次数',
          decompressFailed: '解压失败次数',
        },
        hotspots: {
          hint: '热点区只展示脱敏后的模型、分组和 API Key 信息。',
          failedWithFallback: '热点缓存统计刷新失败，当前展示上次成功数据。',
          rank: '排名',
          model: '热点模型',
          group: '热点分组',
          apiKey: '热点 API Key',
        ...
        savings: {
          localTokens: '本地响应缓存节省 tokens',
          localAmount: '本地响应缓存节省金额',
          promptRead: '上游 Prompt Cache read tokens',
          promptWrite: '上游 Prompt Cache write tokens',
          promptAmount: '上游 Prompt Cache 节省金额',
          totalAmount: '总预估节省',
          priceMissingModels: '价格缺失模型：{models}',
          priceComplete: '价格配置完整',
        },
        empty: {
          hotspots: '暂无热点缓存',
          promptCache: '暂无上游 Prompt Cache 数据',
        },
      },
      clearPage: {
        title: '缓存清理',
        description: '按范围清理本地响应缓存；危险操作需要二次确认，执行中禁止重复提交。',
        reset: '重置范围',
        submit: '执行清理',
        submitting: '清理中...',
        submitSuccess: '清理完成',
        submitPartial: '清理已执行，请检查结果详情',
        submitFailed: '清理提交失败，请稍后重试',
        groupsLoadFailed: '分组列表加载失败',
        clearTypeTitle: '清理类型',
        clearTypeHint: '按 PRD 限定的清理范围执行，本页不会清空缓存统计数据。',
        scopeTitle: '清理范围',
        scopeHint: '仅展示当前 FE-017 所需字段；全部清理需要输入确认文本。',
        allHint: '全部缓存清理不可撤销，提交前必须再次确认。',
        expiredHint: '过期缓存清理不会要求额外范围条件，适合日常维护。',
        previewTitle: '操作预览',
        previewType: '清理类型',
        previewScope: '清理范围',
        previewHint: '请先核对清理范围。提交后会立即调用后端清理接口并返回匹配/删除结果。',
        resultTitle: '最近一次清理结果',
        resultMatched: '匹配 Key 数',
        resultDeleted: '删除 Key 数',
        auditTitle: '清理审计列表',
        auditHint: '展示最近的缓存清理记录，支持按操作人、类型、结果和时间范围筛选；运维账号只读查看。',
        auditRefresh: '刷新审计',
        auditRefreshing: '刷新中...',
        auditLoadFailed: '清理审计加载失败',
        auditEmpty: '暂无清理审计记录',
        auditMatchedShort: '匹配',
        auditScopeAll: '全部缓存',
        resultSuccess: '清理完成：删除 {deleted} 个缓存 Key，共匹配 {matched} 个。',
        resultPartial: '部分清理成功：删除 {deleted} 个缓存 Key，共匹配 {matched} 个。失败原因：{reason}',
        resultFailed: '清理失败：{reason}',
        confirmTitle: '确认缓存清理',
        confirmDescription: '该操作不可撤销，请再次确认清理范围后再提交。',
        confirmInputLabel: '请输入确认文本',
        confirmInputPlaceholder: '请输入：确认清理',
        confirmSubmit: '确认清理',
        auditColumns: {
          id: '审计 ID',
          operator: '操作人',
        ...
        auditValidation: {
          timeRequired: '审计筛选的开始和结束时间必须同时填写。',
          timeInvalid: '审计筛选时间无效，请重新选择。',
          timeOrder: '审计筛选的开始时间必须早于结束时间。',
          timeRange: '审计筛选时间范围不能超过 31 天。',
        },
        fields: {
          platforms: '平台',
          models: '模型',
          modelsPlaceholder: '输入模型名称后按回车或点击添加',
          modelsEmpty: '尚未添加任何模型',
          modelsHint: '当前仓库没有独立模型搜索接口，先按模型名手动添加多个清理目标。',
          groups: '分组',
          groupsHint: '可多选分组，提交时只会发送当前选中的分组 ID。',
          apiKeys: 'API Key',
          apiKeysPlaceholder: '输入 Key 名称后搜索',
          apiKeysEmpty: '未找到匹配的 API Key',
          apiKeysHint: '当前搜索接口返回名称和 ID，不返回完整 Key 明文。',
          startTime: '开始时间',
          endTime: '结束时间',
        },
        types: {
        ...
        typeHints: {
          expired: '清理已过期缓存，无需额外条件。',
          byPlatform: '按平台多选清理缓存。',
          byModel: '按模型名称清理缓存。',
          byGroup: '按分组范围清理缓存。',
          byApiKey: '按 API Key 范围清理缓存。',
          byTime: '按时间范围清理缓存，最长 31 天。',
          all: '清空本地响应缓存，不影响统计数据。',
        },
        validation: {
          default: '请先修正范围配置后再提交。',
          platforms: '请选择至少一个平台。',
          models: '请至少添加一个模型。',
          groups: '请至少选择一个分组。',
          apiKeys: '请至少选择一个 API Key。',
          timeRequired: '请选择完整的开始和结束时间。',
          timeInvalid: '时间格式无效，请重新选择。',
          timeOrder: '开始时间必须早于结束时间。',
          timeRange: '时间范围不能超过 31 天。',
        },
      },
    },
    settings: {
      ...
      features: {
        ...
        availableChannels: {
          title: '可用渠道',
          description: '向已登录客户展示其可访问的渠道、分组、模型和定价。',
          configureLink: '前往 渠道管理 > 渠道定价 配置渠道价格',
          enabled: '显示可用渠道',
          enabledHint: '关闭后客户侧边栏隐藏“可用渠道”，原有渠道配置和价格数据保留。',
        },
        modelSquare: {
          title: '模型广场',
        ...
        openaiRemoteCompactionV2: {
          ...
          description: '控制所有客户的原生 Remote Compaction V2 协议。',
          enabled: '启用 Remote Compaction V2',
          enabledHint: '关闭后仅拒绝 V2 协议；旧版 /responses/compact 路径保持可用，便于回滚。',
        },
        groupUsageRollup: {
          title: '分组用量聚合',
          description: '控制分组用量聚合读取和后台聚合任务。',
          enabled: '启用分组用量聚合',
          enabledHint: '关闭后分组用量改读实时数据，后台任务暂停；已有聚合和失效标记会保留，重新开启后继续恢复。',
        },
        salesPricingResolver: {
          title: '销售定价解析器',
          description: '控制销售定价是否参与实际请求计费。当前服务端状态会显示在右侧。',
          currentEnabled: '当前状态：已开启',
          currentDisabled: '当前状态：已关闭',
          dangerWarning: '危险操作：切换后会立即影响新请求的销售价格解析和计费结果。提交前请确认回滚范围，并填写可审计的切换理由。',
          enabled: '启用销售定价解析器',
          enabledHint: '开启和关闭都属于计费变更，必须填写切换理由。',
          reason: '销售定价切换理由',
          reasonPlaceholder: '说明变更原因、影响范围或回滚依据',
          reasonHint: '仅在切换状态时提交，必须为 5–500 个字符。',
          reasonValidation: '切换销售定价状态时，理由必须为 5–500 个字符。',
        },
        openaiTeamLinkedResolver: {
          title: 'OpenAI Team 联动解析器',
          description: '控制 Team 工作区停用时的跨账号联动、探测和专用错误处理。',
          currentEnabled: '当前状态：已开启',
          currentDisabled: '当前状态：已关闭',
          dangerWarning: '关闭后只停止新的 Team 联动和自动探测；已有 Team 保护记录会保留，避免绕过现有暂停状态。',
          enabled: '启用 Team 联动解析器',
          enabledHint: '切换后立即影响新的 Team 工作区停用处理，必须填写切换理由。',
          reason: 'Team 联动切换理由',
          reasonPlaceholder: '说明变更原因、影响范围或回滚依据',
          reasonHint: '仅在切换状态时提交，必须为 5–500 个字符。',
          reasonValidation: '切换 Team 联动状态时，理由必须为 5–500 个字符。',
        },
        riskControl: {
          title: '风控中心',
      ...
      registration: {
        ...
        domainLimit: '注册主域名数量限制',
        domainLimitHint: '按邮箱主域名限制账号数量，关闭时不生效。',
        domainLimitUnit: '个账号/主域名',
        xSearchPrice: 'x_search 按次价格',
        xSearchPriceHint: '填写正数 USD，最多 10 位小数。留空表示不启用 x_search 计价。',
        xSearchPriceLoadError: 'x_search 价格暂时不可用，其他设置仍可编辑。',
        xSearchPriceSaveError: 'x_search 价格保存失败，其他设置已保留。',
        promoCode: '优惠码',
      ...
      customMenu: {
        title: '自定义菜单页面',
        description: '添加自定义页面到侧边栏导航。每个页面可以设置为普通用户或管理员可见。',
        itemLabel: '菜单项 #{n}',
        name: '菜单名称',
        namePlaceholder: '如：帮助中心',
        url: '页面 URL',
        urlPlaceholder: 'https://example.com/page、https://cc-ai.xyz/seedance-video-guide.html 或 md:api-key-guide',
        urlHint: '填写完整 http(s) 链接会在自定义页面中展示；本站静态 HTML 说明页会保留系统左侧菜单；填写 md:slug 会使用下方 Markdown 正文生成站内独立页面。',
        markdownContent: 'Markdown 页面正文',
        markdownContentPlaceholder: '在此输入 Markdown 文档正文，代码示例请使用 ``` 包裹。',
        markdownContentHint: '该正文将显示在 /custom/:id 独立页面中，代码块会自动显示复制按钮。',
        iconSvg: 'SVG 图标',
      ...
      balanceNotify: {
        title: '余额不足提醒',
        description: '开启后系统每 5 分钟扫描用户余额，低于阈值时向注册邮箱发送提醒',
        enabled: '启用余额不足提醒',
        threshold: '全局提醒阈值',
        thresholdHint: '所有用户统一使用此阈值，余额低于该金额时发送提醒',
        thresholdPlaceholder: '输入金额',
        rechargeUrl: '充值页面 URL',
        rechargeUrlPlaceholder: 'https://example.com/payment',
        rechargeUrlHint: '设置后邮件中将包含充值链接按钮',
        excludedUsers: '排除名单',
        excludedUsersHint: '加入排除名单的用户不会收到余额不足邮件提醒。',
        searchPlaceholder: '输入用户邮箱或用户名添加排除账号',
        excludedUsersEmpty: '暂无排除账号',
      },
      quotaNotify: {
        title: '账号限额通知',
