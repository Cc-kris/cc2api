  ...
  admin: {
    ...
    settings: {
      ...
      customMenu: {
        ...
        url: '页面 URL',
        urlPlaceholder: 'https://example.com/page、/seedance-video-guide.html 或 md:api-key-guide',
        urlHint: '填写完整 http(s) 链接会打开外部页面；填写 / 开头的站内路径会打开本站页面；填写 md:slug 会使用下方 Markdown 正文生成站内独立页面。',
