...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    meta: {
      ...
      requiresAdmin: true,
      title: 'Alert Rules',
      titleKey: 'admin.ops.alertRules.title',
      descriptionKey: 'admin.ops.alertRules.description'
    }
  },
  {
    path: '/admin/ops/ai-analysis',
    name: 'AdminOpsAIAnalysis',
    component: () => import('@/views/admin/ops/OpsAIAnalysisView.vue'),
    meta: {
      requiresAuth: true,
      requiresAdmin: true,
      title: 'AI Analysis',
      titleKey: 'admin.ops.aiAnalysis.title',
      descriptionKey: 'admin.ops.aiAnalysis.description'
    }
  },
  {
    path: '/admin/users',
  ...
  },
  {
    ...
    meta: { requiresAuth: true, requiresAdmin: true, title: 'Business & Finance', titleKey: 'nav.financeStats' }
  },
  {
  ...
  {
    path: '/admin/settings/cache/advanced',
    name: 'AdminCacheAdvanced',
    component: () => import('@/views/admin/cache/AdvancedCachePanel.vue'),
    meta: {
      requiresAuth: true,
      requiresAdmin: true,
      title: 'Advanced Cache',
      titleKey: 'admin.cacheManagement.advancedPage.title',
      descriptionKey: 'admin.cacheManagement.advancedPage.description'
    }
  },
  {
  ...
  {
    path: '/admin/settings/cache/semantic-audits',
    name: 'AdminSemanticCacheAudits',
    component: () => import('@/views/admin/cache/SemanticAuditPanel.vue'),
    meta: {
      requiresAuth: true,
      requiresAdmin: true,
      title: 'Semantic Cache Audits',
      titleKey: 'admin.cacheManagement.semanticAuditPage.title',
      descriptionKey: 'admin.cacheManagement.semanticAuditPage.description'
    }
  },
  {
